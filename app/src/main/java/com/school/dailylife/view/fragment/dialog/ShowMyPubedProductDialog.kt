 ...
 * on 20-12-15
 */
class ShowMyPubedProductDialog(val dataBean: List<SoledProductBean>) : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val adapter = CommonRecyclerAdapter<SoledProductBean>(
            ...
            dataBean,
            {
                ...
                tv_dialog_product_isSoled.text = if (it.soled) "已卖出" else "在售"
            }
        )
